/**
 * Schema of `<root>/.mookf/config.yaml`
 *
...
export const MookfConfigSchema = z.object({
...
export type MookfConfig = z.infer<typeof MookfConfigSchema>;

export const DEFAULT_CONFIG: MookfConfig = {
  schema_version: 1,
  ignore: [],
